...
public final class ActivityLanguageBinding implements ViewBinding {
  ...
  private ActivityLanguageBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView recyclerLanguages) {
  ...
  public static ActivityLanguageBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.recyclerLanguages;
      RecyclerView recyclerLanguages = ViewBindings.findChildViewById(rootView, id);
      if (recyclerLanguages == null) {
        break missingId;
      }

      return new ActivityLanguageBinding((LinearLayout) rootView, recyclerLanguages);
    }
